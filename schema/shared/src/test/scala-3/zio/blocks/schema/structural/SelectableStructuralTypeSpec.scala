...
/**
 * Tests that verify Selectable-based structural type Schema derivation works on all platforms.
 * 
 * Selectable subtypes with a Map[String, Any] constructor (or companion apply) work
 * cross-platform because they don't require reflection for construction/deconstruction.
 * 
