...
object IntoSpec extends ZIOSpecDefault {
  ...
  object TestFixtures {
    ...
    case class LargeV1(
      ...
      f11: Int, f12: String, f13: Boolean, f14: Long, f15: Double
    )
    case class LargeV2(
      f1: Long, f2: String, f3: Boolean, f4: Long, f5: Double,
      f6: Long, f7: String, f8: Boolean, f9: Long, f10: Double,
      f11: Long, f12: String, f13: Boolean, f14: Long, f15: Double
    )
    ...
    suite("Schema Evolution")(
      ...
      suite("Combined Evolution Patterns")(
        ...
        test("field reordering with optional and defaults") {
          ...
          case class OrderV2(customerId: String, id: String, total: Double, status: Option[String], discount: Double = 0.0)
    ...
    suite("Edge Cases")(
      ...
      suite("Recursive Types")(
        ...
        test("deeply nested structures (5+ levels)") {
          ...
          val deep = Level1(1, Some(Level2("a", Some(Level3(2L, Some(Level4(3.0, Some(Level5(true, Some(Level6(4)))))))))))
