 ...
 * 
 * These tests verify that certain invalid conversions are caught at compile-time
 * rather than runtime. Some tests are commented out because they should fail to compile.
 * 
