...
/**
 * Tests for Scala 3 selector-based MigrationBuilder API.
 */
object MigrationBuilderSelectorSpec extends SchemaBaseSpec {
  ...
  object PersonV3 {
    given Schema[PersonV3] = Schema.derived
  }

  def spec: Spec[TestEnvironment, Any] = suite("MigrationBuilderSelectorSpec - Scala 3")(
