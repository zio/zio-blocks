  ...
  def spec: Spec[TestEnvironment, Any] = suite("DynamicPatchSpec")(
    ...
    suite("StringOp")(
      test("inserts text") {
        ...
        val patch = DynamicPatch(Operation.PrimitiveDelta(
    ...
    suite("SeqOp")(
      test("appends elements") {
        val old = DynamicValue.Sequence(Vector(
        ...
        val patch = DynamicPatch(Operation.SequenceEdit(Vector(
    ...
    suite("MapOp")(
      test("adds a key") {
        val old = DynamicValue.Map(Vector(
        ...
        val patch = DynamicPatch(Operation.MapEdit(Vector(
          MapOp.Add(
    ...
    suite("RecordPatch")(
      test("modifies a record field") {
        val old = DynamicValue.Record(Vector(
        ...
        val patch = DynamicPatch(Operation.RecordPatch(Vector(
