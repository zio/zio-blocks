    ...
    suite("Optional")(
      ...
      test("toDynamic") {
        ...
        assert(Case6.akmil.toDynamic)(
          equalTo(DynamicOptic(Vector(Field("mil"), AtMapKey(DynamicValue.Primitive(PrimitiveValue.Int(1))))))
        ) &&
              ...
              OpticCheck(
                errors = ::(
                  MissingKey(
                    ...
                    prefix =
                      DynamicOptic(Vector(Field("mil"), AtMapKey(DynamicValue.Primitive(PrimitiveValue.Int(1))))),
                    key = 1
                  ),
                  Nil
                )
