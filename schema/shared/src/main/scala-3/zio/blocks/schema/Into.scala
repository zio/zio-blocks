...
private object IntoMacro {
  ...
  private def numericCoercion[A: Type, B: Type](using Quotes)(
  ...
  private def coproductTypeConversion[A: Type, B: Type](using Quotes)(
    source: quotes.reflect.TypeRepr,
    target: quotes.reflect.TypeRepr
  ): Option[Expr[Into[A, B]]] = {
    import quotes.reflect.*
  ...
  /**
   * Get constructor signature as a list of parameter types.
   * Returns empty list for case objects or if no constructor found.
   */
  ...
  private def generateCoproductConversion[A: Type, B: Type](using Quotes)(
    source: quotes.reflect.TypeRepr,
    target: quotes.reflect.TypeRepr,
