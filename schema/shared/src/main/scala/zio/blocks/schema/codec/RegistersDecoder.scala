...
final class RegistersDecoder(depth: Int) {
  private[this] var _registers: Array[Registers]        = Array.fill(depth)(Registers(RegisterOffset.Zero))
  private[this] var constructors: Array[Constructor[_]] = Array.fill(depth)(null)
