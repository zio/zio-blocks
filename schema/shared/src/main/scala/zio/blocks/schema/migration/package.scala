 ...
 * ==Basic Usage==
 *
 * {{` import zio.blocks.schema._ import zio.blocks.schema.migration._
 *
 * // Define your schema versions case class PersonV1(name: String) case class
 * PersonV2(name: String, age: Int)
 *
 * implicit val v1Schema: Schema[PersonV1] = Schema.derived implicit val
 * v2Schema: Schema[PersonV2] = Schema.derived
 *
 * // Create a migration val migration = Migration .newBuilder[PersonV1,
 * PersonV2] .addField(_.age, 0) .build
 *
 * // Apply the migration val personV1 = PersonV1("John") val result:
 * Either[MigrationError, PersonV2] = migration(personV1) // result ==
 ...
 *
 * {{` val v1ToV2 = Migration.newBuilder[PersonV1, PersonV2].addField(_.age,
 * 0).build val v2ToV3 = Migration.newBuilder[PersonV2,
 * PersonV3].addField(_.email, "").build
 *
 ...
 *
 * {{` val v1ToV2 = Migration.newBuilder[PersonV1, PersonV2].addField(_.age,
 * 0).build val v2ToV1 = v1ToV2.reverse `}}
 *
