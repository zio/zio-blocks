...
object DynamicOptic {
  ...
  object Node {
    ...
    implicit lazy val elementsSchema: Schema[Elements.type] = new Schema(
      reflect = new Reflect.Record[Binding, Elements.type](
        fields = Vector.empty,
        typeId =
          TypeId.nominal("Elements", Owner.parse("zio.blocks.schema.DynamicOptic.Node"), Nil, TypeDefKind.Object),
    ...
    implicit lazy val mapKeysSchema: Schema[MapKeys.type] = new Schema(
      reflect = new Reflect.Record[Binding, MapKeys.type](
        fields = Vector.empty,
        typeId = TypeId.nominal("MapKeys", Owner.parse("zio.blocks.schema.DynamicOptic.Node"), Nil, TypeDefKind.Object),
        recordBinding = new Binding.Record(
    ...
    implicit lazy val mapValuesSchema: Schema[MapValues.type] = new Schema(
      reflect = new Reflect.Record[Binding, MapValues.type](
        fields = Vector.empty,
        typeId =
          TypeId.nominal("MapValues", Owner.parse("zio.blocks.schema.DynamicOptic.Node"), Nil, TypeDefKind.Object),
        recordBinding = new Binding.Record(
    ...
    implicit lazy val wrappedSchema: Schema[Wrapped.type] = new Schema(
      reflect = new Reflect.Record[Binding, Wrapped.type](
        fields = Vector.empty,
        typeId = TypeId.nominal("Wrapped", Owner.parse("zio.blocks.schema.DynamicOptic.Node"), Nil, TypeDefKind.Object),
        recordBinding = new Binding.Record(
    ...
    implicit lazy val fieldSchema: Schema[Field] = new Schema(
      reflect = new Reflect.Record[Binding, Field](
        ...
        typeId = TypeId.nominal(
          "Field",
          Owner.parse("zio.blocks.schema.DynamicOptic.Node"),
          Nil,
    ...
    implicit lazy val schema: Schema[Node] = new Schema(
      reflect = new Reflect.Variant[Binding, Node](
        ...
        typeId = TypeId.nominal("Node", Owner.parse("zio.blocks.schema.DynamicOptic"), Nil, TypeDefKind.Enum(Nil)),
  ...
  implicit lazy val schema: Schema[DynamicOptic] = new Schema(
    reflect = new Reflect.Record[Binding, DynamicOptic](
      ...
      typeId = TypeId.nominal[DynamicOptic](
        "DynamicOptic",
        "zio.blocks.schema",
        Nil
      ),
