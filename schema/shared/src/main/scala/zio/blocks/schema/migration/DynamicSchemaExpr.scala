...
object DynamicSchemaExpr {
  ...
  final case class Relational(left: DynamicSchemaExpr, right: DynamicSchemaExpr, operator: SchemaExpr.RelationalOperator) extends DynamicSchemaExpr
  final case class Logical(left: DynamicSchemaExpr, right: DynamicSchemaExpr, operator: SchemaExpr.LogicalOperator) extends DynamicSchemaExpr
  final case class Not(expr: DynamicSchemaExpr) extends DynamicSchemaExpr
  final case class Arithmetic(left: DynamicSchemaExpr, right: DynamicSchemaExpr, operator: SchemaExpr.ArithmeticOperator) extends DynamicSchemaExpr
