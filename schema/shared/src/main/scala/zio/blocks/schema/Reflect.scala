...
sealed trait Reflect[F[_, _], A] extends Reflectable[A] { self =>
  ...
  def fromDynamicValue(value: DynamicValue, trace: List[DynamicOptic.Node])(implicit
    F: HasBinding[F]
...
object Reflect {
  ...
  case class Primitive[F[_, _], A](
    ...
    def fromDynamicValue(value: DynamicValue, trace: List[DynamicOptic.Node])(implicit
      ...
      primitiveType.fromDynamicValue(value, trace)
  ...
  case class Deferred[F[_, _], A](_value: () => Reflect[F, A]) extends Reflect[F, A] { self =>
    ...
    def fromDynamicValue(value: DynamicValue, trace: List[DynamicOptic.Node])(implicit
      ...
      this.value.fromDynamicValue(value, trace)
