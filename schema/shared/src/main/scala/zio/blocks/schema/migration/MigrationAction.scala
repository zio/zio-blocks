 ...
 * reversed to support bidirectional migrations.
 */
...
object MigrationAction {
   ...
   *
   * @param at
   *   the path of the field to drop
   * @param defaultForReverse
   *   the default value to use when reversing this action
   */
   ...
   *
   * @param at
   *   the path of the field to rename
   * @param to
   ...
   *
   * @param at
   *   the path of the optional field
   * @param default
   *   the default value to use when the field is None
   */
   ...
   *
   * @param at
   *   the path of the field to make optional
   */
   ...
   *
   * @param at
   *   the path where the joined field will be created
   * @param sourcePaths
   *   the paths of the fields to join
   * @param combiner
   *   the expression that combines the source fields
   */
   ...
   *
   * @param at
   *   the path of the field to split
   * @param targetPaths
   *   the paths where the split fields will be created
   * @param splitter
   *   the expression that splits the source field
   */
   ...
   *
   * @param at
   *   the path of the field to change
   * @param converter
   ...
   * @param actions
   *   the migration actions to apply to the case
   */
