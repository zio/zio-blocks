...
object AvroCodecDeriver extends Deriver[AvroCodec] {
        ...
        try {
          ...
          try {
            new DynamicValue.Primitive((idx: @scala.annotation.switch) match {
              ...
              case 16 => new PrimitiveValue.LocalDateTime(AvroCodec.localDateTimeCodec.decodeValue(decoder))
              ...
              case 20 => new PrimitiveValue.OffsetDateTime(AvroCodec.offsetDateTimeCodec.decodeValue(decoder))
              ...
              case 27 => new PrimitiveValue.ZonedDateTime(AvroCodec.zonedDateTimeCodec.decodeValue(decoder))
