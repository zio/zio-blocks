    ...
    extends BinaryFormat(
      ...
      new Deriver[AvroBinaryCodec] {
        ...
        private[this] val recursiveRecordCache =
          new ThreadLocal[java.util.HashMap[zio.blocks.typeid.TypeId[?], (Array[AvroBinaryCodec[?]], AvroSchema)]] {
            override def initialValue
              : java.util.HashMap[zio.blocks.typeid.TypeId[?], (Array[AvroBinaryCodec[?]], AvroSchema)] =
