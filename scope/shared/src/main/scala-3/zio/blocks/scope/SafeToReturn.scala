...
object SafeToReturn extends SafeToReturnMidPriority {
   ...
   */
  given globalScope[A]: SafeToReturn[A, Scope.GlobalTag] =
...
trait SafeToReturnMidPriority extends SafeToReturnLowPriority {
   ...
   */
  given nothing[S]: SafeToReturn[Nothing, S] =
   ...
   */
  given unscoped[A, S](using Unscoped[A]): SafeToReturn[A, S] =
...
trait SafeToReturnLowPriority {
   ...
   */
  given scoped[B, T, S](using S <:< T): SafeToReturn[B @@ T, S] =
