...
This guide assumes familiarity with ZIO Blocks schemas and basic optics. See the [Schema](../reference/zio-blocks-schema/schema.md) and [Optics](../reference/zio-blocks-schema/optics.md) reference pages for background.
...
- **[Optics Reference](../reference/zio-blocks-schema/optics.md)** -- Full API coverage of Lens, Prism, Optional, and Traversal
- **[DynamicOptic Reference](../reference/zio-blocks-schema/dynamic-optic.md)** -- Runtime optic paths for programmatic query construction
- **[Schema Reference](../reference/zio-blocks-schema/schema.md)** -- Schema derivation and type-level metadata
