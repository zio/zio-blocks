...
val r: Reader.SyncReader[Byte] = Reader.fromChunk(Chunk[Byte](1, 2, 3))
...
import zio.blocks.chunk.Chunk
import zio.blocks.streams.io.Reader
val r: Reader.SyncReader[Int] = Reader.fromChunk(Chunk[Int](1, 2, 3))
val buf = new Array[Byte](4)
r.readBytes(buf, 0, 4)
"""))
    },
...
import zio.blocks.chunk.Chunk
import zio.blocks.streams.io.Reader
val r: Reader.SyncReader[Char] = Reader.fromChunk(Chunk[Char]('a', 'b'))
val buf = new Array[Byte](4)
r.readBytes(buf, 0, 4)
"""))
    },
