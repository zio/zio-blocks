...
object TypeId extends TypeIdCompanionVersionSpecific {
  ...
  val localDateTime: TypeId[java.time.LocalDateTime] =
    nominal[java.time.LocalDateTime]("LocalDateTime", javaTimeOwner, Nil)
  ...
  val offsetDateTime: TypeId[java.time.OffsetDateTime] =
    nominal[java.time.OffsetDateTime]("OffsetDateTime", javaTimeOwner, Nil)
  ...
  val zonedDateTime: TypeId[java.time.ZonedDateTime] =
    nominal[java.time.ZonedDateTime]("ZonedDateTime", javaTimeOwner, Nil)
  ...
  val map: TypeId[Map[_, _]] =
    nominal[Map[_, _]]("Map", scalaCollectionImmutableOwner, List(TypeParam("K", 0), TypeParam("V", 1)))
  ...
  val arraySeq: TypeId[scala.collection.immutable.ArraySeq[_]] =
    nominal[scala.collection.immutable.ArraySeq[_]]("ArraySeq", scalaCollectionImmutableOwner, List(TypeParam("A", 0)))
  val indexedSeq: TypeId[IndexedSeq[_]] =
    nominal[IndexedSeq[_]]("IndexedSeq", scalaCollectionImmutableOwner, List(TypeParam("A", 0)))
