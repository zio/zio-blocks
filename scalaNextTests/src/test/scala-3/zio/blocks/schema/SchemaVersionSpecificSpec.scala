            ...
            new Schema[NamedTuple4](
              reflect = Reflect.Record[Binding, NamedTuple4](
                ...
                typeName = TypeName(
                  ...
                  name = "NamedTuple[b,sh,i,l][Byte, Short, Int, Long]",
                  params = Nil
                ),
                recordBinding = null
              )
          ...
          equalTo(
            new Schema[(i: Int, s: String)](
              reflect = Reflect.Record[Binding, (i: Int, s: String)](
                ...
                typeName = TypeName(
                  namespace = Namespace(Seq("scala"), Seq("NamedTuple")),
                  name = "NamedTuple[i,s][Int, String]",
                  params = Nil
                ),
                recordBinding = null
              )
          ...
          equalTo(
            new Schema[(i: Int, s: String)](
              reflect = Reflect.Record[Binding, (i: Int, s: String)](
                ...
                typeName = TypeName(
                  namespace = Namespace(Seq("scala"), Seq("NamedTuple")),
                  name = "NamedTuple[i,s][Tuple2[Int, Long], Tuple2[String, String]]",
                  params = Nil
                ),
                recordBinding = null
              )
          ...
          equalTo(
            new Schema[(i: Option[Int], s: Option[String])](
              reflect = Reflect.Record[Binding, (i: Option[Int], s: Option[String])](
                ...
                typeName = TypeName(
                  namespace = Namespace(Seq("scala"), Seq("NamedTuple")),
                  name = "NamedTuple[i,s][Option[Int], Option[String]]",
                  params = Nil
                ),
                recordBinding = null
              )
          ...
          equalTo(
            new Schema[GenericNamedTuple2[Int, String]](
              reflect = Reflect.Record[Binding, GenericNamedTuple2[Int, String]](
                ...
                typeName = TypeName(
                  namespace = Namespace(Seq("scala"), Seq("NamedTuple")),
                  name = "NamedTuple[a,b][Int, String]",
                  params = Nil
                ),
                recordBinding = null
              )
          ...
          equalTo(
            new Schema[HKNamedTuple2[List, Set]](
              reflect = Reflect.Record[Binding, HKNamedTuple2[List, Set]](
                ...
                typeName = TypeName(
                  namespace = Namespace(Seq("scala"), Seq("NamedTuple")),
                  name = "NamedTuple[a,b][List[Int], Set[String]]",
                  params = Nil
                ),
                recordBinding = null
              )
