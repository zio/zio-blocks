...
final class BlockingMpmcRingBuffer[A <: AnyRef](val capacity: Int) {
   ...
   */
  def offer(a: A): Unit =
    throw new UnsupportedOperationException("BlockingMpmcRingBuffer.offer is not supported on Scala.js")

  /**
   * Not supported on Scala.js. Always throws `UnsupportedOperationException`.
   */
  def take(): A =
    throw new UnsupportedOperationException("BlockingMpmcRingBuffer.take is not supported on Scala.js")
