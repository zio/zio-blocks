...
/**
 * Scala.js stub for [[BlockingSpscRingBuffer]].
 *
...
final class BlockingSpscRingBuffer[A <: AnyRef](val capacity: Int) {
   ...
   */
  def offer(a: A): Unit =
    throw new UnsupportedOperationException("BlockingSpscRingBuffer.offer is not supported on Scala.js")
   ...
   */
  def take(): A =
    throw new UnsupportedOperationException("BlockingSpscRingBuffer.take is not supported on Scala.js")
