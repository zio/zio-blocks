  ...
  def spec: Spec[TestEnvironment, Any] = suite("JsonFormatVersionSpecificSpec")(
    suite("records")(
      test("generic tuples") {
        ...
        roundTrip[GenericTuple4]((1: Byte) *: (2: Short) *: 3 *: 4L *: EmptyTuple, """{"_1":1,"_2":2,"_3":3,"_4":4}""")
      }
    ),
    suite("enums")(
      ...
      test("complex recursive values") {
        ...
        roundTrip(
          ...
          """{"Node":{"value":{"Some":{"value":"VVV"}},"next":{"Node":{"value":{"None":{}},"next":{"End":{}}}}}}"""
        )(schema2)
      },
      test("union type") {
        ...
        roundTrip[Value]((1, true), """{"Tuple2":{"_1":1,"_2":true}}""") &&
