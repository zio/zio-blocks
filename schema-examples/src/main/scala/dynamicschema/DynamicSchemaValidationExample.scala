 ...
 *
 * Run with: sbt "schema-examples/runMain dynamicschema.DynamicSchemaValidationExample"
 */
object DynamicSchemaValidationExample extends App {
  ...
  val missingAge = DynamicValue.Record(Chunk(
  ...
  val extraField = DynamicValue.Record(Chunk(
