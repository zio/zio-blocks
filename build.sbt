...
addCommandAlias(
  "testJVM",
  "+typeidJVM/test; +schemaJVM/test; +chunkJVM/test; +streamsJVM/test; +schema-avro/test; benchmarks/test; examples/test"
)
addCommandAlias(
  "testJS",
  "+typeidJS/test; +schemaJS/test; +chunkJS/test; +streamsJS/test"
)
addCommandAlias(
  "testNative",
  "+typeidNative/test; +schemaNative/test; +chunkNative/test; +streamsNative/test"
)
