...
inThisBuild(
  List(
    ...
    // deploy-preview.yml is now generated by zio-sbt-ci itself (since 0.8.0); without this the
    // plugin deletes the file and ciCheckGithubWorkflow (the lint job) fails on the mismatch.
...
lazy val benchmarks = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.41.1",
