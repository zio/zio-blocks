...
trait HtmlElements {
  ...
  def area: Dom.Element       = Dom.Element.Generic("area", Chunk.empty, Chunk.empty)
  ...
  def base: Dom.Element       = Dom.Element.Generic("base", Chunk.empty, Chunk.empty)
  ...
  def br: Dom.Element         = Dom.Element.Generic("br", Chunk.empty, Chunk.empty)
  ...
  def col: Dom.Element        = Dom.Element.Generic("col", Chunk.empty, Chunk.empty)
  ...
  def embed: Dom.Element      = Dom.Element.Generic("embed", Chunk.empty, Chunk.empty)
  ...
  def hr: Dom.Element         = Dom.Element.Generic("hr", Chunk.empty, Chunk.empty)
  ...
  def img: Dom.Element        = Dom.Element.Generic("img", Chunk.empty, Chunk.empty)
  def input: Dom.Element      = Dom.Element.Generic("input", Chunk.empty, Chunk.empty)
  ...
  def link: Dom.Element       = Dom.Element.Generic("link", Chunk.empty, Chunk.empty)
  ...
  def meta: Dom.Element       = Dom.Element.Generic("meta", Chunk.empty, Chunk.empty)
  ...
  def param: Dom.Element      = Dom.Element.Generic("param", Chunk.empty, Chunk.empty)
  ...
  def source: Dom.Element  = Dom.Element.Generic("source", Chunk.empty, Chunk.empty)
  ...
  def track: Dom.Element                = Dom.Element.Generic("track", Chunk.empty, Chunk.empty)
  ...
  def wbr: Dom.Element                  = Dom.Element.Generic("wbr", Chunk.empty, Chunk.empty)
