...
class IntoBenchmarks {
  ...
  def coproductConversion(): Any = {
    ...
    case class CreatedV1(name: String, id: Int) extends EventV1
    case object DeletedV1                       extends EventV1

    sealed trait EventV2
    case class CreatedV2(name: String, id: Long) extends EventV2
    case object DeletedV2                        extends EventV2

    val into = Into.derived[EventV1, EventV2]
    into.intoOrThrow(CreatedV1("test", 42))
  }
