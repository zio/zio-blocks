...
/**
 * Complete example showing how to migrate a Person schema through multiple
 * versions.
 *
 * Evolution: V1: firstName, lastName V2: fullName, age (combine names, add age)
...
object PersonMigrationExample extends ZIOAppDefault {
   ...
   *
   * Note: To transform age to birthYear (2024 - age), you would need to add a
   * SubtractFrom transformation to SerializableTransformation, or use a custom
   * expression-based transformation system.
   */
