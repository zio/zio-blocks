...
import cloud.golem.data.{ElementSchema, GolemSchema, NamedElementSchema, StructuredSchema}
import cloud.golem.runtime.MethodMetadata
import cloud.golem.runtime.plan.{AgentClientPlan, ClientInvocation, ClientMethodPlan, ConstructorPlan}
  ...
  private def multiParamSchemaExpr(using
    ...
    '{
      new GolemSchema[Vector[Any]] {
        ...
        override def decode(
          value: _root_.cloud.golem.data.StructuredValue
