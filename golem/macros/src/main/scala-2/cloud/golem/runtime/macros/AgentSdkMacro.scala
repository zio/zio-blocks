...
object AgentSdkMacroImpl {
  def derivedImpl[Trait: c.WeakTypeTag](c: blackbox.Context): c.Expr[_root_.cloud.golem.sdk.AgentApi[Trait]] = {
    import c.universe._
    ...
    c.Expr[_root_.cloud.golem.sdk.AgentApi[Trait]](
      q"""
      new _root_.cloud.golem.sdk.AgentApi[$traitTpe] {
        override type Constructor = $ctorTpe
        override val typeName: String = $typeName
        override val plan: _root_.cloud.golem.runtime.plan.AgentClientPlan[$traitTpe, $ctorTpe] =
          _root_.cloud.golem.runtime.macros.AgentClientMacro
            .plan[$traitTpe]
            .asInstanceOf[_root_.cloud.golem.runtime.plan.AgentClientPlan[$traitTpe, $ctorTpe]]
      }
      """
    )
  }
