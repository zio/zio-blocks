...
# 5) copies it into `golem/quickstart/app/wasm/agent_guest.wasm` and `golem/examples/app/wasm/agent_guest.wasm`
#
# Requirements:
# - `curl`, `tar`
...
install -m 0644 "$out_wasm" "$repo_root/golem/quickstart/app/wasm/agent_guest.wasm"
