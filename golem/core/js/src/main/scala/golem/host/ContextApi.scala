 ...
 *
 * This is intentionally a thin layer: it exposes the host module and a few
 * typed entrypoints. Resource/value shapes follow the JS/WIT binding
 * conventions and may evolve with the host.
 */
object ContextApi {
