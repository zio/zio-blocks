 ...
 *
 * The CLI-backed JVM test client is Scala 3-only (for now). This keeps `+compile`
 * working while the primary Scala SDK story remains Scala.js (agent-to-agent calls inside Golem).
 */
